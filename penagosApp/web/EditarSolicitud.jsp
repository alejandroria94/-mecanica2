...
<html>
    ...
    <body >
        <div ng-app="penagosApp">
            ...
            <div ng-controller="penagosEditarSolicitudAppCtrl as st" > <!--formulario-->
                    ...
                    <div class="col s10 offset-s1">
                        <div class="row">
                            <div class="input-field col s3">
                                <input id="last_name" type="text" class="validate " ng-model="st.codigo" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Codigo</label> 
                            </div>
                            <div class="input-field col s3">
                                <input id="last_name" type="text" class="validate " ng-model="st.revision" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Revision</label> 
                            </div>
                            <div class="input-field col s3">
                                <input id="last_name" type="text" class="validate "ng-model="st.solicitud" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Solicitud de servicio</label> 
                            </div>
                            <div class="input-field col s3">
                                <input type="text" class="datepicker" ng-model="st.fecha" placeholder="">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s3">
                        <input id="last_name" type="text" class="validate "  readonly ng-model="st.seccion" placeholder="">
                        <label for="last_name" class="indigo-text text-darken-4" >Seccion</label> 
                    </div>
                    <div class="input-field col s3">
                        <input id="last_name" type="text" class="active validate "  readonly  ng-model="st.operario" placeholder="">
                ...
                <div class="row">
                    <div class="col s10 offset-s1">
                        <div class="row">
                            ...
                            <div class="col s2">
                                <p>
                                    <input type="checkbox" id="reparacion" ng-model="st.reparacion" placeholder="" />
                                    <label for="reparacion">Reparacion</label>
                                </p>
                            </div>
                            <div class="col s2">
                                <p>
                                    <input type="checkbox" id="electrico" ng-model="st.mtoelectrico"  />
                ...
                <div class="row">
                    <div class="input-field col s10 offset-s1">
                        ...
                        <textarea id="textarea1" class="materialize-textarea" length="120" ng-model="st.servicio" placeholder=""></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s10 offset-s1">
                ...
                <div class="row">
                    <div class="col s10 offset-s1">
                        <div class="row">
                            <div class="input-field col s3">
                                <input id="last_name" type="number" class="validate "ng-model="st.horasparada" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Total horas parada</label> 
                            </div>
                            <div class="input-field col s3">
                                <input id="last_name" type="number" class="validate " ng-model="st.horasmto" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Total horas mto</label> 
                            </div>
                            <div class="input-field col s3">
                                <input id="timepicker_ampm_dark"  placeholder="" class="timepicker" type="text"ng-model="st.horasolicitud" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4 " >Hora solicitud</label> 
                            </div>
                            <div class="input-field col s3">
                                <input id="timepicker_ampm_dark" placeholder="" class="timepicker" type="text" ng-model="st.horaentrega" placeholder="">
                    ...
                    <div class="col s10 offset-s1">
                        <div class="row">
                            <div class="input-field col s4">
                                <input id="last_name" type="text" class="validate "ng-model="st.solicitado" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Servicio solicitado por</label> 
                            </div>
                            <div class="input-field col s4">
                                <input id="last_name" type="text" class="validate " ng-model="st.realizado" placeholder="">
                                <label for="last_name" class="indigo-text text-darken-4" >Servicio realizado por</label> 
                            </div>
                            <div class="input-field col s4">
                                <input class="validate" d="last_name"  type="text" ng-model="st.recibido" placeholder="">
