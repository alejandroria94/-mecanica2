...
<html>
    ...
    <body >
        <div ng-app="penagosApp">
            ...
            <div ng-controller="penagosProvppCtrl as p" > <!--formulario-->
                <div class="row">
                    <div class="col s2 offset-s5">
                        <legend><strong  class="indigo-text text-darken-4" style="font-size: 20px">Nuevo Proveedor</strong></legend>
                    </div>
                </div>
                <div class="row">
                    <div class="col s10 offset-s1">
                        <div class="row">
                            <div class="input-field col s6">
                                <input id="last_name" type="text" class="validate " ng-model="p.nombre">
                                <label for="last_name" class="indigo-text text-darken-4" >Nombre</label> 
                            </div>
                            <div class="input-field col s6">
                                <input id="last_name1" type="text" class="validate " ng-model="p.direccion">
                                <label for="last_name1" class="indigo-text text-darken-4" >Direccion</label> 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s10 offset-s1">
                        <div class="row">
                            <div class="input-field col s6">
                                <input id="last_name2" type="text" class="validate " ng-model="p.telefono">
                                <label for="last_name2" class="indigo-text text-darken-4" >Telefono</label> 
                            </div>
                            <div class="input-field col s6">
                                <input id="last_name3" type="text" class="validate " ng-model="p.correo">
                                <label for="last_name3" class="indigo-text text-darken-4" >Correo</label> 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s4 right">
                        <a class="waves-effect red darken-2 btn left-align" href="ListaProveedores.jsp">Cancelar</a>
                        <a class="waves-effect  green  btn left-align" ng-click="p.guardar()">Guardar</a>
                    </div>
                </div>
