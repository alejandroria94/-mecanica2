    ...
    public boolean actualizarOrdenDeTrabajo() {
        ...
        if (conexion.setAutoCommitBD(false)) {
            ...
            String sql2 = "UPDATE `ordenesdetrabajo` SET numeroOrdenDeTrabajo='" + this.numeroOrdenDeTrabajo + "',fechaInicio='" + dateFormat.format(this.fechaInicio) + "',fechaFin='" + dateFormat.format(this.fechaFin) + "',tipoSolicitud='" + this.tipoSolicitud + "'"
                    ...
                    + ",descripcionDanos='" + this.descripcionDanos + "',descripcionTrabajosRealizados='" + this.descripcionTrabajosRealizados + "',ejecutadoPor='" + this.ejecutadoPor + "',recibidoAprobadoPor='" + this.recibidoAprobadoPor + "',dptAdmyControl='" + this.dptAdmyControl + "',ruta='"+this.ruta+"',pdf='"+this.pdf+"',cerrada='"+this.cerrada+"'"
